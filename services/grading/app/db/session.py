"""
Async SQLAlchemy engine and session factory for the Grading Service.
"""
...
def init_db(database_url: str) -> None:
    ...
    logger.info("db_engine_initialized", extra={"service": "grading"})
...
async def close_db() -> None:
    ...
    if _engine is not None:
        ...
        _engine = None
        logger.info("db_engine_closed", extra={"service": "grading"})
