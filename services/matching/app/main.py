...
Consumes HyperlocalMatchRequested → scores nearby buyers → emits MatchFound|NoMatchFound + ProductListed.
"""
...
from app.api.routes import router as matching_router
...
async def lifespan(application: FastAPI):
    ...
    consumer_task = asyncio.create_task(
        start_consumer(redis_url=settings.redis_url, group="matching")
    )
